...
// (on the QueryRunner's EntityManager). It is never a DI token — the UoW's createContext()
// constructs the scoped implementation and hands it out as `ctx.transactions`.
//
