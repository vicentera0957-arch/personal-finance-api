...
export class NullBudgetsCache extends IBudgetsCache {
  async getListByUser(_userId: string, _options?: BudgetQueryOptions): Promise<Budget[] | null> {
    return null;
  }
  async setListByUser(_userId: string, _options: BudgetQueryOptions | undefined, _budgets: Budget[]): Promise<void> {}
